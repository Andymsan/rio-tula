...
| Industria | Verbatim | Se quitaron los **XX** (empresas). "Inspeccionado a XX industrias" → **92 inspecciones** (Excel, cuenta inspecciones, no industrias). "Certificando a XX" → **29 industrias**. |
| Colectores | Verbatim, con 35.8 km y 72 descargas del Excel | Se corrigió mi "se vertía" → "**se vierte**". |
| Monitoreo | Verbatim, con 5 estaciones | Se quitó "de **XX** km de río" y "**3 campañas**" (el Excel dice secas y lluvias; sin confirmar). "Más de 95 sitios" se mantiene. |
| Ecosistemas · intro | Verbatim | Nada |
| Riberas | Verbatim (1,600 y 300 árboles) | Se quitó "los **XX** km de riberas". Se explica "heno motita". |
| Bosques | Verbatim (1,700 ha) | Se quitó "**100 ha**" iniciales (no confirmado) y "**XX** ha" → 663 ha (Excel: terminado). |
| Endhó / Bojay | Verbatim | Se quitó "**55 ha**" (Excel dice 50 ha de humedal; sin confirmar). |
| Espacio público | Verbatim (5 sitios; intervenciones integrales) | Se corrigió "simultanea". |
| Alcance / Conexión (tarjetas de la pptx) | Verbatim (52 % a 15 min; 12 km) | Nada |
| Taludes | Verbatim con 4.47 km (Excel) | "**XX** km" → 4.47 km |
