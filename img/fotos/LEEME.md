...
| `taludes-2.jpg` | San Lorenzo · después |
| `taludes-3.jpg` | El Chamizal · obra en proceso |
| `desazolve-1.jpg` | Desazolve del cauce |
| `desazolve-2.jpg` | Antes y después |
| `caudal-1.jpg` | Estación de monitoreo de caudal |
| `riberas-1.jpg` | Saneamiento forestal de riberas |
| `riberas-2.jpg` | Revegetación de riberas |
| `bojay-1.jpg` | Ciénegas de Endhó (Bojay) |
